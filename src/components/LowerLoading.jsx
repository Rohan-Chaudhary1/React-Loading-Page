...
const LowerLoading = () => {
  ...
  return (
    <main className='w-[1100px] mx-auto md:flex justify-between '>
       ...
       <footer className=''>
        <div className='w-[150px] h-[15px] bg-gray-200'></div>
            <div className='w-[400px] h-[30px] bg-gray-200 my-3'></div>
            <section className='flex gap-5'>
                <div className='w-[100px] h-[20px] bg-gray-200'></div>
                <div className='w-[100px] h-[20px] bg-gray-200'></div>
            </section>
            <div className='w-[500px] h-[15px] bg-gray-200 my-3'></div>
            <div className='w-[500px] h-[15px] bg-gray-200 my-3'></div>
       </footer>
       ...
       <footer className='flex gap-10'>
            ...
            <section >
                {array.map(index=>(
                    <div className='w-[400px] h-[40px] bg-gray-200 mb-3'></div>
                ))}
            </section>
       </footer>
